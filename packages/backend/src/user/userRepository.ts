...
import { CreateUserResponseSchema, ErrorResponseSchema, type CreateUserResponse, type ErrorResponse } from "@setest/shared/responses";
...
export class UserRepository {
    ...
    async create(body: unknown) : Promise<ResponseData<ErrorResponse> | ResponseData<CreateUserResponse>>
    {
